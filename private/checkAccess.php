...
// Description
// -----------
// This function will check if the user has access to the library module.  
//
// Arguments
// ---------
// ciniki:
...
function ciniki_library_checkAccess(&$ciniki, $business_id, $method) {
	...
	if( !isset($rc['ruleset']) ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'2094', 'msg'=>'No permissions granted'));
	}
	...
	if( $rc['stat'] != 'ok' ) {
		return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'2092', 'msg'=>'Access denied.'));
	}
	//
	...
	// By default fail
	//
	return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'2093', 'msg'=>'Access denied'));
}
?>
